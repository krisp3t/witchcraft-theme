...
$column_1_text = get_field('column_1_text') ?: ''; // Don't forget to escape!
	...
	<div class="row">
		<div class="col-sm card text-center my-2 my-sm-0 mr-sm-2 py-3 shadow-sm border">
			...
			<div class="card-body">
				...
				<p class="card-text"><?php echo wp_kses($column_1_text, '') ?></p>
			</div>
		</div>
		<div class="col-sm card text-center my-2 my-sm-0 mx-sm-2 py-3 shadow-sm border">
			...
			<div class="card-body">
				...
				<p class="card-text"><?php echo wp_kses($column_2_text, '') ?></p>
			</div>
		</div>
		<div class="col-sm card text-center my-2 my-sm-0 ml-sm-2 py-3 shadow-sm border">
			...
			<div class="card-body">
				...
				<p class="card-text"><?php echo wp_kses($column_3_text, '') ?></p>
			</div>
		</div>
	</div>
</div>
